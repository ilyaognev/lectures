...
1. [Service Discovery in Microservice Architecture](https://www.codeprimers.com/service-discovery-in-microservice-architecture/)
2. [Конструктивные шаблоны облачных решений](https://docs.microsoft.com/ru-ru/azure/architecture/patterns/)